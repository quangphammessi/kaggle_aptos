...
criterion = nn.MultiLabelSoftMarginLoss(weight=class_weight_)
# criterion = nn.BCEWithLogitsLoss(weight=class_weight_)
...
def quadratic_kappa(y_hat, y):
    return torch.tensor(cohen_kappa_score(torch.round(y_hat), y, weights='quadratic')).cuda()
