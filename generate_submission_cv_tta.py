...
def load_model(model_number):
    ...
    model.load_state_dict(torch.load('./saved_model/20190831_data3k_effib4_aug_clean_fold_%d.pt' %model_number))
    model.cuda()
...
if __name__ == "__main__":
    ...
    for fold in range(NUMBER_OF_FOLD):
        ...
        submission_csv.to_csv("./submission/submission_fold_%d.csv" %fold, index=False)
        print('Done!')
